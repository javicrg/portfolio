...
export default function Contact() {
	...
	function handleForm(e) {
		...
		axios
			.post("https://formsubmit.co/ajax/jcareagamoraleda@gmail.com", {
				name: name,
				message: message,
				email: email,
			})
	...
	return (
		<>
			...
			<h1
				id="contact"
				className="mt-20 mb-8 font-extrabold text-center text-4xl text-transparent bg-clip-text bg-gradient-to-tr from-[#d7d7d7] to-[#616161]"
			>
				Contact Me
			</h1>
			<section
					...
					>
						...
						<div className="text-center">
							<input
								...
								type="submit"
								value="Submit"
								className="px-4 py-2 rounded-md bg-white font-bold hover:cursor-pointer"
							/>
						</div>
					</form>
				</div>
